...
import com.linkpal.domain.entity.RequestErrorInfo;
import com.linkpal.domain.entity.RequestInfo;
...
public class LogAspect {
    ...
    public Object doAround(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        weblog.setClassMethod(String.format("%s.%s", proceedingJoinPoint.getSignature().getDeclaringTypeName(),
                proceedingJoinPoint.getSignature().getName()));
        weblog.setArgs(getRequestParamsByProceedingJoinPoint(proceedingJoinPoint).toString());
        ...
        weblog.setTimeCost( (System.currentTimeMillis() - start));
